...
@section('metas')
    <meta name="title" content="Our Team at Quay Space – Meet Experts, Join Us Today">
    <meta name="description" content="Our Team at Quay Space – Get to know our expert team driving flexible office solutions. Connect with the crew, learn what makes us tick & discover how we can help.">
    <meta property="og:title" content="Our Team at Quay Space – Meet Experts, Join Us Today">
    <meta property="og:description" content="Our Team at Quay Space – Get to know our expert team driving flexible office solutions. Connect with the crew, learn what makes us tick & discover how we can help.">
    <meta name="twitter:title" content="Our Team at Quay Space – Meet Experts, Join Us Today">
    <meta name="twitter:description" content="Our Team at Quay Space – Get to know our expert team driving flexible office solutions. Connect with the crew, learn what makes us tick & discover how we can help.">
    <meta name="twitter:domain" content="{{ env("APP_URL") }}">
@stop


@section('title')
    Our Team at Quay Space – Meet Experts, Join Us Today
@stop
...
@section('content')
    ...
    <section class="page-title-area about-banner" style="background-image: url('frontend/assets/imgs/banner/ourteam.jpg');">
