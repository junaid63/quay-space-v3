 <!-- footer area start  -->
            <footer class="footer-main section-spacing pb-0">
                <div class="container">
                    <div class="row">
                        <!-- Column 1 -->
                        <div class="col-12 col-lg-5 col-md-6 footer-widget">
                        ...
                        <div class="col-12 col-lg-4 col-md-6 tablet-flex">
                            ...
                            <div class="footer-contact-location">
                                <h4 class="crp-footer-widget-title mb-lg-4 mb-md-4 mb-3">Call Us on
                                </h4>
                                <p>
                                    <a href="mailto:{{setting('site.gmail')}}">{{setting('site.gmail')}}</a><br>
                                    <a class="footer-call-number" href="tel:{{setting('site.phone')}}">
                                        {{setting('site.phone')}}
                                    </a>
                                </p>
                            </div>
