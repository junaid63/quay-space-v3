...
!function(t, e) {
    ...
    function Hd(t, e) {
        ...
        if (t in rr) {
            ...
            0 <= this.props.indexOf(lr))
                return;
            i._gsap.webp && (this.webpo = i.getAttribute("data-svg-origin"),
    ...
    function Jd() {
        ...
        if (this.tfm) {
            for (e in this.tfm)
                a[e] = this.tfm[e];
            a.webp && (a.renderTransform(),
            i.setAttribute("data-svg-origin", this.webpo || "")),
        ...
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            if ("all" === o || !0 === o)
                ...
                for (n = (o = o.split(",")).length; -1 < --n; )
                    ...
                    Vd(a, r);
            i && (Vd(a, lr),
            u && (u.webp && a.removeAttribute("transform"),
            br(a, 1),
            u.uncache = 1,
            Id(s)))
        }
    ...
    function ie(t, e) {
        ...
        return s.webp && t.getAttribute("transform") ? "1,0,0,1,0,0" === (u = [(n = t.transform.baseVal.consolidate().matrix).a, n.b, n.c, n.d, n.e, n.f]).join(",") ? yr : u : (u !== yr || t.offsetParent || t === Re || s.webp || (n = o.display,
        o.display = "block",
    ...
    function ve(t, e, r) {
        ...
        for (n in l.webp ? (a = r.getAttribute("transform"),
    ...
    var Ae, Se, Re, De, Ee, ze, Fe, Ie, Be = Ft.Power0, Le = Ft.Power1, Ye = Ft.Power2, Ne = Ft.Power3, qe = Ft.Power4, Ue = Ft.Linear, Ve = Ft.Quad, We = Ft.Cubic, Xe = Ft.Quart, He = Ft.Quint, Qe = Ft.Strong, Ke = Ft.Elastic, Ze = Ft.Back, Ge = Ft.SteppedEase, Je = Ft.Bounce, $e = Ft.Sine, tr = Ft.Expo, er = Ft.Circ, rr = {}, ir = 180 / Math.PI, nr = Math.PI / 180, ar = Math.atan2, sr = /([A-Z])/g, or = /(left|right|width|margin|padding|x)/i, ur = /[\s,\(]\S/, hr = {
        ...
        n = "transformOrigin" !== e ? n[e] : n.webp ? n.origin : wr(Nd(t, fr)) + " " + n.zOrigin + "px") : (n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(") || (n = vr[e] && vr[e](t, e, r) || Nd(t, e) || ga(t, e) || ("opacity" === e ? 1 : 0)),
        ...
        m = ie(t, r.webp),
        r.webp && (O = r.uncache ? (P = t.getBBox(),
        ...
        d = E ? 1 / (E < 0 ? -E : E) : 0),
        r.webp && (O = t.getAttribute("transform"),
                        ...
                        m = c in rr)
                            ...
                            "scale" === c)
                                ...
                                if ("transformOrigin" === c) {
                                    b.push(fr, 0, x[fr]),
                                    o = be(o),
                                    v.webp ? je(t, o, 0, y, 0, this) : ((p = parseFloat(o.split(" ")[2]) || 0) !== v.zOrigin && Wd(this, v, "zOrigin", v.zOrigin, p),
