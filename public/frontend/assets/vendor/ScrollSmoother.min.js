        ...
        Ka(),
            ...
            this.content = function(e) {
                if (arguments.length) {
                    ...
                    if (t !== n) {
                        ...
                        // ✅ Sticky fix inside smooth-content
                        n.querySelectorAll(".sticky-section").forEach(function(sticky) {
                            // remove GSAP transform from sticky
                            D.set(sticky, { clearProps: "transform" });

                            ScrollTrigger.create({
                                trigger: sticky,
                                start: "top top", // stick from top
                                end: "bottom+=99999 top", // stick until very long
                                pin: true,
                                pinSpacing: false,
            ...
            this.wrapper = function(e) {
                return arguments.length ? (
                    b = q(e || "#smooth-wrapper")[0] || function _wrap(e) {
                        var t = N.querySelector(".ScrollSmoother-wrapper");
                        return t || ((t = N.createElement("div")).classList.add("ScrollSmoother-wrapper"),
                                e.parentNode.insertBefore(t, e),
                                t.appendChild(e)),
